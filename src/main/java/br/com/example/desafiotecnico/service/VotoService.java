...
import br.com.example.desafiotecnico.exception.VotoInvalidoException;
...
public class VotoService {
    ...
    public VotoDto save(VotoDto votoDto) {
        ...
        entity.setPauta(pautaService.findByNomeOrThrowBadRequestException(votoDto.getNomePauta()));
        ...
        if (!validaCpfAssiciado(votoDto.getCpfAssociado())) {
            ...
            throw new VotoInvalidoException("CPF '" + votoDto.getCpfAssociado() + "' não habilitado para votação!");
        }
        ...
        if (aux.isPresent()) {
            log.debug("CPF '{}' já votou na pauta {}!", votoDto.getCpfAssociado(), votoDto.getNomePauta());
    ...
    private boolean validaCpfAssiciado(String cpfAssociado) {
        try {
            ...
            if (response.getStatusCode().equals(HttpStatus.OK)) {
                ...
                throw new VotoInvalidoException("CPF '" + cpfAssociado + "' inválido!");
            }
